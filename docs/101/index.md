...
### 1. [Why Anonymize?](why-anonymization.md)
...
### 2. [Where is it Needed?](where-needed.md)
...
### 3. [Contemporary Techniques & Tools](techniques.md)
...
### 4. [How PDF Anonymizer is Different](how-different.md)
...
Let's begin! First, we will explore the fundamental question: [**Why do we need anonymization and deanonymization?**](why-anonymization.md)
