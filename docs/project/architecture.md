...
### 1. Text Extraction & PDF Conversion
...
### 5. Placeholder Mapping Generation
...
### 6. Replacing by Length Descending
...
### 1. Bidirectional Mapping Compatibility
