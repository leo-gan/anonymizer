...
class TestConsolidation(unittest.TestCase):
    def test_consolidate_mapping(self):
        ...
        """
        anonymized_text = "PERSON_1 is meeting with PERSON_2 and PERSON_3. ADDRESS_1 is the location."
        mapping = {
            "PERSON_1": "John Doe",
            "PERSON_2": "John Doe",
            "PERSON_3": "Jane Smith",
        ...
        expected_text = "PERSON_1 is meeting with PERSON_1 and PERSON_3. ADDRESS_1 is the location."
        expected_mapping = {
            "PERSON_1": "John Doe",
            "PERSON_3": "Jane Smith",
            "ADDRESS_1": "123 Main St"
        ...
        consolidated_text, consolidated_mapping = consolidate_mapping(anonymized_text, mapping)
    ...
    def test_consolidate_mapping_no_duplicates(self):
        ...
        """
        anonymized_text = "PERSON_1 is meeting with PERSON_3. ADDRESS_1 is the location."
        mapping = {
            "PERSON_1": "John Doe",
            "PERSON_3": "Jane Smith",
            "ADDRESS_1": "123 Main St"
